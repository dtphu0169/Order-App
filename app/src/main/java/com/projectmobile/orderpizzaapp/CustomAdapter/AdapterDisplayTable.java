...
import com.projectmobile.orderpizzaapp.Activities.PaymentActivity;
import com.projectmobile.orderpizzaapp.DAO.BanAnDAO;
import com.projectmobile.orderpizzaapp.DAO.DonDatDAO;
import com.projectmobile.orderpizzaapp.Model.BanAnModel;
...
public class AdapterDisplayTable extends BaseAdapter implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String kttinhtrang = banAnDAO.LayTinhTrangBanTheoMa(banAnModel.getMaBan());
        ...
        switch (id){
            ...
            case R.id.img_customtable_GoiMon:
                ...
                if(tinhtrang.equals("false")){
                    ...
                    long ktra = donDatDAO.ThemDonDat(donDatModel);
