...
import com.projectmobile.orderpizzaapp.CustomAdapter.AdapterDisplayPayment;
import com.projectmobile.orderpizzaapp.DAO.BanAnDAO;
import com.projectmobile.orderpizzaapp.DAO.DonDatDAO;
import com.projectmobile.orderpizzaapp.DAO.ThanhToanDAO;
...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(maban !=0 ){
            ...
            for (int i = 0; i< thanhToanModels.size(); i++){
                int soluong = thanhToanModels.get(i).getSoLuong();
                int giatien = thanhToanModels.get(i).getGiaTien();
    ...
    private void HienThiThanhToan(){
        ...
        thanhToanModels = thanhToanDAO.LayDSMonTheoMaDon(madondat);
